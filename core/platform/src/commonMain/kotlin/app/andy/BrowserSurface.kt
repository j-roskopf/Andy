...
enum class BrowserEngineStage { Locating, Downloading, Extracting, Install, Initializing, Initialized }

sealed class BrowserEngineState {
 ...
 */
@Composable
expect fun rememberBrowserEngineState(): BrowserEngineState
 ...
 */
expect fun resignEmbeddedBrowserKey()

/** Give the embedded WKWebView key-window status. No-op off macOS. */
expect fun focusEmbeddedBrowser()
 ...
 */
expect fun closeEmbeddedBrowser()
