...
fun bugPlaybackMillis(report: BugReport, frameIndex: Int, frameCount: Int): Long {
...
fun activeBugActionIndex(actions: List<BugAction>, playbackMillis: Long): Int {
    return actions
...
fun activeBugPointerEvent(actions: List<BugAction>, playbackMillis: Long): BugPointerEvent? {
    return actions
...
fun parseBugActionPoint(action: BugAction): Pair<Int, Int>? {
