 ...
 */
fun trimFrameIndices(timestampsMillis: List<Long>, startMillis: Long, endMillis: Long): List<Int> {
...
fun trimmedTimestamps(timestampsMillis: List<Long>, startMillis: Long, endMillis: Long): List<Long> =
 ...
 */
fun uniformFrameTimestamps(frameCount: Int, startMillis: Long, endMillis: Long): List<Long> {
...
fun validateRecordingExportRequest(
