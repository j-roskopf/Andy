...
fun AccessibilityNode.findBestNodeAt(x: Int, y: Int): AccessibilityNode? {
 ...
 */
fun resolveHierarchyDisplaySize(
    rootBounds: String?,
    wmWidth: Int,
    wmHeight: Int,
...
fun scalePointFromStreamToDisplay(
    x: Int,
    y: Int,
    displayWidth: Int,
    displayHeight: Int,
...
fun distanceSquaredToBounds(x: Int, y: Int, bounds: List<Int>): Int {
    val dx = when {
