...
internal data class DhuWindowRef(
    val id: String,
    val pid: Long?,
    val title: String,
)

internal data class DhuWindowBounds(
    val x: Int,
    val y: Int,
    val width: Int,
    val height: Int,
...
internal sealed interface DhuPointerAction {
 ...
 */
internal interface DhuWindowHost {
...
internal fun createDhuWindowHost(): DhuWindowHost {
...
internal class UnsupportedDhuWindowHost(
