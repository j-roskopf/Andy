...
internal object AndydProcess {
    ...
    internal fun removeStaleArtifacts(
        socketPath: File = socketPath(),
        pidPath: File = pidPath(),
    ) {
    ...
    internal fun isPidAlive(pidPath: File = pidPath()): Boolean {
    ...
    internal fun waitForSocket(socketPath: File, timeoutMs: Long, pollMs: Long = 100): Boolean {
    ...
    internal fun tryLaunch(): Boolean {
     ...
     */
    internal fun resolveLaunchCommand(): List<String>? {
    ...
    internal fun appMacOsDirectory(): File? {
...
internal fun deleteSocketIfStale(socketPath: File) {
