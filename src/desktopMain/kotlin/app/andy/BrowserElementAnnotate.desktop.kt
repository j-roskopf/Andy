...
internal actual fun setBrowserElementInspectEnabled(enabled: Boolean) {
...
internal fun parseAnnotateEvent(json: String?, png: ByteArray?): BrowserElementAnnotateEvent {
