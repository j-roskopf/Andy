 ...
 */
internal fun AccessibilityNode.filterInvisible(): AccessibilityNode? {
...
internal fun AccessibilityNode.matchesHierarchyQuery(query: String): Boolean {
 ...
 */
internal fun AccessibilityNode.filterBySearch(query: String): AccessibilityNode? {
