...
data class WorkspaceState(
    ...
    val terminalThemeId: String = TerminalThemePreset.Andy.id,
    val terminalForegroundHex: String = TerminalThemePreset.Andy.foregroundHex,
    val terminalBackgroundHex: String = TerminalThemePreset.Andy.backgroundHex,
    val terminalSelectionFgHex: String = TerminalThemePreset.Andy.selectionFgHex,
    val terminalSelectionBgHex: String = TerminalThemePreset.Andy.selectionBgHex,
    val terminalFoundFgHex: String = TerminalThemePreset.Andy.foundFgHex,
    val terminalFoundBgHex: String = TerminalThemePreset.Andy.foundBgHex,
    val terminalHyperlinkFgHex: String = TerminalThemePreset.Andy.hyperlinkFgHex,
    val terminalHyperlinkBgHex: String = TerminalThemePreset.Andy.hyperlinkBgHex,
    val terminalUseInverseSelection: Boolean = TerminalThemePreset.Andy.useInverseSelection,
    val terminalColorPaletteId: String = TerminalColorPaletteKind.Xterm.id,
