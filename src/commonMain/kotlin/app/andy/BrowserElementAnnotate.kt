 ...
 */
internal data class BrowserElementAnnotation(
    val comment: String,
    val tag: String,
    val selector: String,
    val url: String,
...
internal sealed class BrowserElementAnnotateEvent {
...
internal fun formatBrowserElementAnnotation(annotation: BrowserElementAnnotation): String = buildString {
...
internal expect fun setBrowserElementInspectEnabled(enabled: Boolean)

/**
 * Subscribe to inspect cancel/submit events from WKWebView. The returned lambda
 * unregisters. No-op off desktop/macOS.
 */
internal expect fun observeBrowserElementAnnotations(
