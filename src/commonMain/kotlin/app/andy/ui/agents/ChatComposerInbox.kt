 ...
 */
internal data class ChatComposerAttachment(
    val imagePaths: List<String> = emptyList(),
    val text: String = "",
)

internal class ChatComposerInbox {
...
internal val LocalChatComposerInbox = staticCompositionLocalOf { ChatComposerInbox() }

@Composable
internal fun CollectChatComposerInbox(
    active: Boolean,
...
internal fun applyChatComposerAttachment(
