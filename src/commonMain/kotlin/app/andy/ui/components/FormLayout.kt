 ...
 */
internal enum class FormLayoutDirection {
    Vertical,
    Horizontal,
    HorizontalLabels,
}

internal val LocalFormLayoutDirection = staticCompositionLocalOf { FormLayoutDirection.Vertical }
