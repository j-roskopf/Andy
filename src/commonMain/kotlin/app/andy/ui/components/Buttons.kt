...
internal fun Button(
    ...
    shape: androidx.compose.ui.graphics.Shape = RoundedCornerShape(AndyRadius.Row),
    colors: ButtonColors = primaryButtonColors(),
    contentPadding: PaddingValues = PaddingValues(horizontal = AndySpace.Space4, vertical = 0.dp),
