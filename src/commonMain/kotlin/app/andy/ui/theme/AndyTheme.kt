...
internal data class AndyTonalPalette(
...
internal data class AndySemanticTokens(
...
@Composable
internal fun andyTokens(): AndySemanticTokens = LocalAndyTokens.current

/** Mutable theme state — updated by [AndyTheme]; exposed via [LocalAndyTokens]. */
internal data class AndyColorsState(
...
internal val Border get() = AndyColors.BorderEmphasized
