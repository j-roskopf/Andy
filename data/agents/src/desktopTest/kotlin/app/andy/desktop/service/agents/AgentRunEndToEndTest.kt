    ...
    private suspend fun assertRetryRestartsTask(
        ...
        try {
            ...
            store.save(
                AgentStoreState(
                    tasks = listOf(task),
                    binaryOverrides = harnessBinaryOverridesForCodex(trueBinary.absolutePath),
...
private class FakeWorkspaceStore(
    private val workspace: WorkspaceState = WorkspaceState(),
) : WorkspaceStore {
    override suspend fun load(): WorkspaceState = workspace
