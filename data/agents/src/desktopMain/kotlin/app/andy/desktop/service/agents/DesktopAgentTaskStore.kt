...
internal fun AgentTaskDto.toModel(scrollbackFile: (String) -> File): AgentTask? {
    ...
    val task = AgentTask(
        ...
        parentChatTaskId = parentChatTaskId.takeIf { it.isNotBlank() },
...
internal fun AgentStoreState.toFileDto(): AgentsFileDto = AgentsFileDto(
    ...
    tasks = tasks.map { task ->
        AgentTaskDto(
            ...
            parentChatTaskId = task.parentChatTaskId.orEmpty(),
            notifyParentOnCompletion = task.notifyParentOnCompletion,
