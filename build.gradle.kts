...
val andyMermaidCrate = layout.projectDirectory.dir("native/andy-mermaid")
...
val buildAndyMermaidNative by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds the merman JNI native library via cargo for the host OS."
