...
/**
 * Parses `wm user-rotation` stdout — see [app.andy.domain.parseWmUserRotation].
 */
internal fun parseWmUserRotation(stdout: String): Int? = app.andy.domain.parseWmUserRotation(stdout)
